    ...
    <div class="content">
        <div class="page-inner">
            <div class="page-header">
                <h4 class="page-title">Tambah Lisensi</h4>
            </div>
            <div class="row">
                <div class="col-md-8">
                    <div class="card">
                        <div class="card-header">
                            <div class="d-flex align-items-center">
                                <h4 class="card-title">Tambah Lisensi EA</h4>
                        ...
                        <div class="card-body">
                            <form action="" method="post">
                                ...
                                <input type="hidden" name="token" value="<?=$this->fungsi->user_login()->token?>">
                                    ...
                                    <input type="text" class="form-control" name="code" value="<?= set_value('code')?>" placeholder="Enter Kode Lisensi">
                                ...
                                <div class="form-group <?=form_error('active_until') ? 'has-error' : null?>" >
                                    ...
                                    <input type="date" class="form-control" name="active_until" value="<?= set_value('active_until')?>" placeholder="Enter Aktif Hingga">
